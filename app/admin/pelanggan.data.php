          ...
          <div class="d-flex">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropmenu">
                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#jpro<?=$j['idjamaah'];?>">Profil</a></li>
                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#jpkt<?=$j['idjamaah'];?>">Paket dipilih</a></li>
              </ul>
            </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-4 col-4">
            ...
            if($j['foto']!='')
             {
                ?>
                <img src="../../assets/jamaah/foto/<?=$j['foto'];?>" class="img-thumbnail shadow-lg"  style="width:100%;max-height: 100px;">
                <?php
             }
             else
             {
                ?>
                <img src="https://img.freepik.com/premium-vector/user-customer-avatar-vector-illustration_276184-160.jpg" class="img-thumbnail shadow-lg"  style="width:100%;">
                <?php
             }
            ?>
          </div>
        ...
        <div class="modal-body p-3">
          <div class="row justify-content-between">
            <div class="col-lg-3 col-md-3">
               ...
               {
                  ?>
                  <img src="../../assets/jamaah/foto/<?=$j['foto'];?>" class="img-thumbnail shadow-lg" >
                  <?php
               }
               else
               {
