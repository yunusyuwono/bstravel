...
$p=mysqli_fetch_array(mysqli_query($kon,"SELECT *,paket.idpaket as idpaket from paket join jampaket on paket.idpaket=jampaket.idpaket where paket.idpaket='$idpaket' and idjamaah='$_SESSION[us]'"));
    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-info shadow-primary border-radius-lg pt-3 pb-2">
          <h6 class="text-white text-capitalize ps-3">Pembayaran Paket <?=$p['nama'];?></h6>
        </div>
      </div>
      <div class="card-body px-3 pb-2" style="height:80vh;overflow: auto;">
      	<div class="row">
            <div class="col-lg-6">
                <form action="fx.jamaah.php?uplbukti" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-6">
                            Total Biaya
                        </div>
            ...
            <div class="col-lg-6">
                <div class="card card-body shadow-lg p-1">
